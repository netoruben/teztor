...
declare namespace nw {
    namespace Window {
        ...
        function get(windowObject?: any): Window;
        function getAll(callback: Window[]): Window[];
        function open(url: string, options?: WindowManifestOptions, callback?: (window: Window) => void): Window;
    }
    
    namespace Clipboard {
        function get(): Clipboard
        function set(data: string, type?: string, raw?: boolean): Clipboard
        function clear()
    }
}
